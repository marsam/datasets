...
class AdmisionComunidadesNativasSpider(CrawlSpider):
  name = 'comunidades_nativas' # solo 'comunidades nativas'
  allowed_domains = ['200.14.241.13']
  start_urls = [
      'http://200.14.241.13/Website20110312/index.html',
      'http://200.14.241.13/Website20110313/index.html',
      ]
  rules = (
      Rule(SgmlLinkExtractor(allow=('M\.html'))),
      #Rule(SgmlLinkExtractor(allow=('\./A/[0-9]*/[0-9]*\.html'), deny=('index\.html')), follow=True),
